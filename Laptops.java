...
public class Main {
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (choice){
                case 1:
                    System.out.println("Минимальный требуемый объем ОЗУ?");
                    filters.put("ram", scanner.nextInt());
                    break;
                case 2:
                    System.out.println("Минимальный требуемый объем ЖД?");
                    filters.put("hdd", scanner.nextInt());
                    break;
                case 3:
                    System.out.println("Требуемая операционная система?");
                    filters.put("os", scanner.next());
                    break;
                case 4:
                    System.out.println("Необходимый цвет?");
